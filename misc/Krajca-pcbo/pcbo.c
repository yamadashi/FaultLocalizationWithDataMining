...
void
    table_of_ints_init(max) int max;
{
  int i;
...
void
    print_thread_info(id, stat) int id;
...
void
    print_initial_thread_info(levels, stat, last_level_concepts) int levels;
struct thread_stat stat;
...
void
    compute_closure(intent, extent, prev_extent, atr_extent, supp) unsigned long *intent,
    *extent, *prev_extent, *atr_extent;
size_t *supp;
{
  int i, j, k, l;
...
void
    generate_from_node(intent, extent, start_int, start_bit, id) unsigned long *intent;
...
void *
#endif
    thread_func(params) void *params;
{
  int id;
  id = *(int *)params;
...
void
    parallel_generate_from_node(intent, extent, start_int, start_bit,
                                rec_level, id) unsigned long *intent;
unsigned long *extent;
